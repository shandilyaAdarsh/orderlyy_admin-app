        ...
        slivers: [
          ...
          SliverAppBar(
            ...
            title: Row(
              children: [
                CircleAvatar(
                  radius: 18.r, backgroundColor: AppTheme.surfaceContainerHigh,
                  child: Icon(Icons.person_rounded, color: AppTheme.secondary, size: 18.r),
                ),
                SizedBox(width: 12.w),
                Expanded(
                  child: Text('Orderlli',
                ...
                children: [
                          ...
                          children: [
                            Text('System / Logistics',
                                style: GoogleFonts.jetBrainsMono(
                                    fontSize: 10.sp, color: AppTheme.secondary, letterSpacing: 1),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis),
                            Text('Inventory',
                                style: GoogleFonts.inter(fontSize: 28.sp, fontWeight: FontWeight.w700,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border(left: BorderSide(color: const Color(0xFFF59E0B), width: 4.w)),
                    ),
                    child: Row(
                      children: [
                        ...
                        Expanded(
                            child: Text('3 items running low — Review now',
                                style: GoogleFonts.inter(fontSize: 13.sp, fontWeight: FontWeight.w500, color: const Color(0xFF78350F)),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis)),
                        TextButton(
                          onPressed: () {},
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: GoogleFonts.inter(fontSize: 13.sp, color: AppTheme.secondary.withValues(alpha: 0.5)),
                      prefixIcon: Icon(Icons.search_rounded, color: AppTheme.secondary, size: 20.r),
                      filled: true,
                      fillColor: AppTheme.surfaceContainerLowest,
                      border: UnderlineInputBorder(
                          borderSide: BorderSide(color: AppTheme.surfaceContainerHigh, width: 2.h)),
                      enabledBorder: UnderlineInputBorder(
                          borderSide: BorderSide(color: AppTheme.surfaceContainerHigh, width: 2.h)),
                      focusedBorder: UnderlineInputBorder(
                          borderSide: BorderSide(color: AppTheme.primaryContainer, width: 2.h)),
                    ),
                  ),
                  SizedBox(height: 20.h),
                ],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: item.status != _StockStatus.healthy
            ? Border(left: BorderSide(color: AppTheme.primaryContainer, width: 3.w))
            : null,
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(item.category,
                      style: GoogleFonts.jetBrainsMono(fontSize: 9.sp, color: AppTheme.secondary, letterSpacing: 1),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis),
                  SizedBox(height: 2.h),
                  Text(item.name,
          ...
          Row(
            ...
            children: [
              Text(item.quantity,
                  style: GoogleFonts.jetBrainsMono(fontSize: 22.sp, fontWeight: FontWeight.w700, color: AppTheme.onSurface)),
              SizedBox(width: 6.w),
              Expanded(
          ...
          Row(
            ...
            children: [
              Text('Utilization',
                  style: GoogleFonts.inter(fontSize: 9.sp, fontWeight: FontWeight.w700, color: AppTheme.secondary, letterSpacing: 1),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis),
              Text(item.fillLabel,
                  style: GoogleFonts.inter(fontSize: 9.sp, fontWeight: FontWeight.w700, color: _accentColor, letterSpacing: 1),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis),
            ],
          ),
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(label,
          style: GoogleFonts.inter(fontSize: 9.sp, fontWeight: FontWeight.w800, color: fg, letterSpacing: 0.5),
          maxLines: 1,
          overflow: TextOverflow.ellipsis),
    );
  }
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.local_shipping_rounded, color: AppTheme.primaryFixed, size: 22.r),
          ),
          SizedBox(height: 16.h),
          ...
          RichText(
            text: TextSpan(
              style: GoogleFonts.inter(fontSize: 13.sp, color: const Color(0xFF94A3B8), height: 1.5),
              children: [
                const TextSpan(text: 'Based on current kitchen velocity, you will exhaust \'Sea Bass\' and \'Asparagus\' in the next '),
                TextSpan(text: '14 hours', style: GoogleFonts.jetBrainsMono(color: Colors.white, fontSize: 13.sp, fontWeight: FontWeight.w600)),
                const TextSpan(text: '.'),
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text('Vendor: FreshCatch Ltd',
                          style: GoogleFonts.jetBrainsMono(fontSize: 9.sp, color: const Color(0xFF64748B), letterSpacing: 0.5),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis),
                    ),
                    Container(width: 6.r, height: 6.r, decoration: const BoxDecoration(color: Color(0xFF10B981), shape: BoxShape.circle)),
                  ],
                ),
                Divider(color: const Color(0xFF334155), thickness: 1, height: 20.h),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Expanded(
                      child: Text('Next Delivery',
                          style: GoogleFonts.inter(fontSize: 12.sp, color: const Color(0xFFCBD5E1)),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis),
                    ),
                    Text('Tomorrow, 06:00 AM',
                        style: GoogleFonts.jetBrainsMono(fontSize: 12.sp, fontWeight: FontWeight.w600, color: Colors.white),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis),
                  ],
                ),
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              child: Text('Auto-order Essentials',
                  style: GoogleFonts.inter(fontSize: 12.sp, fontWeight: FontWeight.w800, letterSpacing: 1),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis),
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: AppTheme.radiusMd,
        border: Border.all(color: AppTheme.surfaceContainerHigh, width: 1.5.w, style: BorderStyle.solid),
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
            ...
            children: [
              for (final color in [const Color(0xFF7C3AED), const Color(0xFF2563EB)])
                Container(
                  ...
                  child: Icon(Icons.person_rounded, color: Colors.white, size: 14.r),
                ),
            ],
          ),
        ],
