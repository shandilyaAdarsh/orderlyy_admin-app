...
class DebugScreen extends StatelessWidget {
  ...
  static const _routes = [
    ...
    ('/manager/dashboard', 'Manager Dashboard',      Icons.supervisor_account_rounded),
    ('/staff/orders',      'Waiter My Orders',       Icons.restaurant_menu_rounded),
    ('/staff/attention',   'Needs Attention',        Icons.notification_important_rounded),
  ];
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            trailing: const Icon(
              ...
              color: Color(0xFFC0272D), size: 20,
            ),
